...
Map<String, dynamic> _$PListBooleanToJson(PListBoolean instance) =>
    <String, dynamic>{
...
PGeoRegion _$PGeoRegionFromJson(Map<String, dynamic> json) {
  return PGeoRegion(
    defaultValue: (json['defaultValue'] as List)
        ?.map((e) =>
            e == null ? null : GeoPosition.fromJson(e as Map<String, dynamic>))
        ?.toList(),
  );
}

Map<String, dynamic> _$PGeoRegionToJson(PGeoRegion instance) =>
    <String, dynamic>{
