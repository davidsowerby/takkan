...
import 'package:precept/precept/part/booleanPart.dart';
...
class ModelConnector<MODEL, VIEW> {
  ...
  /// It is generally better to keep the default settings of the Binding for consistency - using [readModel] is therefore
