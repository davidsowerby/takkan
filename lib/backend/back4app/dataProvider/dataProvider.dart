...
class Back4AppDataProvider extends RestDataProvider<PBack4AppDataProvider> {
  Back4AppDataProvider({@required PBack4AppDataProvider config}) : super(config: config);

  @override
  Authenticator<PBack4AppDataProvider> createAuthenticator(PBack4AppDataProvider config) => Back4AppAuthenticator(config: config);
}
