...
abstract class DataProviderBase<CONFIG extends PDataProviderBase, QUERY extends PQuery>
    implements DataProvider<CONFIG, QUERY> {
  final CONFIG config;
  Authenticator? _authenticator;
  late AppConfig appConfig;

  DataProviderBase({required this.config}) : super();
