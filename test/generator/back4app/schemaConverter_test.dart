import 'dart:convert';
import 'dart:io';
import 'package:precept_dev_generator/generator/back4app/precept_back4app_converter.dart';
...
void main() {
  group('PSchema to Back4AppSchema conversion', () {
    ...
    test('sample class', () {
      ...
      final ServerSchemaClass? schemaClass = extract[documentName];
    ...
    test('reference model, without indexes', () {
      // given
      File f = File('test/generator/back4app/ref-server-schema.json');
