  ...
  group('PScript all level validation', () {
    ...
    group('PComponent validation', () {
      ...
      test('routes and name must not be not empty', () {
        ...
        expect(messages.length, 2);
        expect(messages[0].toString(),
            'PScript : Script:0 : PComponent name cannot be an empty String');
        expect(messages[1].toString(),
            "PComponent : Script:0.Component:0 : unnamed PComponent must contain at least one PRoute");
      });
    });
    ...
    group('PRoute validation', () {
      test('Must have path and page', () {
        ...
        expect(messages.length, 2);
        expect(messages[0].toString(), 'PRoute : test.core.Route:0 : must define a path');
        expect(messages[1].toString(), 'PRoute : test.core.Route:0 : must define a page');
      });
    });
    ...
    group('PPanel validation', () {
      ...
      test('any non-static PPanel must be able to access DataSource', () {
        ...
        expect(withoutDataSourceOrBackendResults[0].toString(),
            'PPanel : Script:0.core./home.Wiggly.panel1 : must either be static or have a dataSource defined');
