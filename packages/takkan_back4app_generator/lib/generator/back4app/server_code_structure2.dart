...
class ServerCodeStructure2 {
  ServerCodeStructure2({required this.outputDir});
...
class VirtualFolder {
  VirtualFolder(this.parent, this.name);

  final VirtualFolder? parent;
  final String name;
  final List<VirtualFolder> subFolders = List.empty(growable: true);
