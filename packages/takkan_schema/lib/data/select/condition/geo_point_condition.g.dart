...
part of 'geo_point_condition.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

GeoPointCondition _$GeoPointConditionFromJson(Map<String, dynamic> json) =>
    GeoPointCondition(
...
Map<String, dynamic> _$GeoPointConditionToJson(GeoPointCondition instance) =>
    <String, dynamic>{
