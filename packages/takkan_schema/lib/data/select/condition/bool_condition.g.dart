...
part of 'bool_condition.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

BoolCondition _$BoolConditionFromJson(Map<String, dynamic> json) =>
    BoolCondition(
...
Map<String, dynamic> _$BoolConditionToJson(BoolCondition instance) =>
    <String, dynamic>{
