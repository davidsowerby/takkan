...
void main() {
  group('DisplayColumns mixin', () {
    ...
    test("Screen size exactly one column wide", () {
      ...
      // when
      final dim = dct.dimensions(screenSize: Size(360, 700), preferredColumnWidth: 360);
      final rowOfColumns =
      dct.distributeWidgets(screenSize: Size(360, 700), preferredColumnWidth: 360, widgets: widgets);
      // then
    ...
    test("Screen size supports two columns exactly", () {
      ...
      // when
      final dim = dct.dimensions(screenSize: Size(720, 700), preferredColumnWidth: 360);
      final rowOfColumns =
      dct.distributeWidgets(screenSize: Size(720, 700), preferredColumnWidth: 360, widgets: widgets);
      // then
    ...
    test("Screen size supports two columns, but widens columns to fit all available space", () {
      // given
      final widgets = [
        MockPanel(),
        MockPanel(),
      ...
      // when
      final dim = dct.dimensions(screenSize: Size(760, 700), preferredColumnWidth: 360);
      final rowOfColumns =
      dct.distributeWidgets(screenSize: Size(760, 700), preferredColumnWidth: 360, widgets: widgets);
      // then
      expect(dim.numberOfColumns, 2);
    ...
    test("Screen size will not support even a single column, column width reduces", () {
      // given
      final widgets = [MockPanel(), MockPanel()];
      // when
      final dim = dct.dimensions(screenSize: Size(320, 700), preferredColumnWidth: 360);
      final rowOfColumns =
      dct.distributeWidgets(screenSize: Size(320, 700), preferredColumnWidth: 360, widgets: widgets);
      // then
      expect(dim.numberOfColumns, 1);
